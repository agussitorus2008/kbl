        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <form id="form_input" class="form d-flex flex-column flex-lg-row"
                    data-kt-redirect="{{ route('backend.cars.index') }}"
                    action="{{ route('backend.cars.update', $car->id) }}" method="PUT" enctype="multipart/form-data">
                    <!--begin::Aside column-->
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="mb-5 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="int" class="form-control mb-2" name="capacity"
                                            placeholder="Enter the capacity of the car..." value="{{ $car->capacity }}" />
                                        <!--end::Input-->
                                        <!--begin::Description-->
