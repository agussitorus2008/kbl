                            ...
                            <div class="card-body pb-0">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <input class="form-control" type="password" name="kpassword_baru"
                                            id="kpassword_baru">
                                    </div>
                                </div>
                                <div class="min-w-150px mt-10 text-end">
                                    <button class="btn btn-primary" id="tombol_simpan"
                                        onclick="handle_save_password('#tombol_simpan','#form-profile','{{ route('web.profile.cpassword') }}','POST');">Kirim</button>
                                </div>
                            </div>
                        </form>
