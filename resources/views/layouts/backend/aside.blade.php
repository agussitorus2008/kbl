    ...
    <div class="aside-toolbar flex-column-auto" id="kt_aside_toolbar">
        ...
        <div class="aside-user d-flex align-items-sm-center justify-content-center py-5">
            ...
            <div class="symbol symbol-50px">
                <img src="{{ asset('backend/media/avatars/blank.png') }}" alt="image" />
            </div>
            <!--end::Symbol-->
            <!--begin::Wrapper-->
            <div class="aside-user-info flex-row-fluid flex-wrap ms-5">
                ...
                <div class="d-flex">
                    ...
                    <div class="flex-grow-1 me-2">
                        ...
                        <!--begin::Description-->
                        <span
                            class="text-gray-600 fw-semibold d-block fs-8 mb-1">{{ Str::ucfirst(Auth::user()->roles->first()->name) }}</span>
                        <!--end::Description-->
                        <!--begin::Label-->
                    ...
                    <div class="me-n2">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                            ...
                            <div class="menu-item px-5">
                                <a href="{{ route('backend.profile.index') }}" class="menu-link px-5">
                                    My Profile
                                </a>
                            </div>
                            <!--end::Menu item-->
    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y px-2 my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ request()->is('backend/drivers/*') || request()->is('backend/drivers') ? 'active' : '' }}"
                        href="{{ route('backend.drivers.index') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                            <span class="svg-icon svg-icon-2">
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ request()->is('backend/cars/*') || request()->is('backend/cars') ? 'active' : '' }}"
                        href="{{ route('backend.cars.index') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                            <span class="svg-icon svg-icon-2">
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ request()->is('backend/schedules/*') || request()->is('backend/schedules') ? 'active' : '' }}"
                        href="{{ route('backend.schedules.index') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                            <span class="svg-icon svg-icon-2">
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ request()->is('backend/chats/*') || request()->is('backend/chats') ? 'active' : '' }}"
                        href="{{ route('backend.chats.index') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                            <span class="svg-icon svg-icon-2">
