    ...
    <div class="toolbar d-flex align-items-stretch">
        ...
        <div
            ...
            <div class="page-title d-flex justify-content-center flex-column me-5">
                <!--begin::Title-->
                <h1 class="d-flex flex-column text-dark fw-bold fs-3 mb-0">@yield('page')</h1>
                <!--end::Title-->
                @yield('breadcrumb')
            </div>
            <!--end::Page title-->
                    ...
                    <div class="d-flex">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <a href="#" onclick="load_notif('{{ route('backend.notification') }}');"
                                class="btn btn-sm btn-icon btn-outline btn-outline-secondary"
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px"
                                ...
                                <div class="d-flex flex-column bgi-no-repeat rounded-top"
                                    style="background-image:url('{{ asset('assets/media/patterns/pattern-1.jpg') }}')">
